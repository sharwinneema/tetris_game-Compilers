...
class TetrisEngine:
	def __init__(self, height=20, width=10, extetromino_distribution=range(1,20), update_duration=100, move_down_duration=1000, Somename=0,difficulty=0,bg_color=4,fg_color=0):
		color_list=['green','light gray','red','yellow','blue']
		...
		self.text_area = tk.Text(										# Essential and partially programmable
															...
															font=('Courier New','30','bold'),		# programmable
														)
